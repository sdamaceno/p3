# texts.py
# Dicionário central de textos, rótulos e formatos (i18n)
...
TEXTOS = {
    "pt-br": {
        # GLOBAIS E CABEÇALHOS
        "NOME_ORGAO": "Tribunal de Justiça do Estado de Goiás",
        "NOME_SISTEMA": "Sistema de Composição de Preços",
        "SUBTITULO_HEADER": "<strong>Planejamento e Cotações</strong><br>Análise de Mercado",
        "SUBTITULO_HERO": "Mapeamento de Demanda, Busca no PNCP e Cadastramento de Cotações Manuais",
        
        # NOVOS GRUPOS SEQUENCIAIS (ANTIGAS ABAS)
        "GRP_OBJETO": "Objeto",
        "GRP_ANALISE": "Análise de Mercado",
        "GRP_RELATORIO": "Relatório",
        
        # ABA 1 - IDENTIFICAÇÃO E ESTRUTURA
        ...
        "BTN_PAUSAR_MASSA": "⏸️ Pausar Busca",
        "BTN_RETOMAR_MASSA": "▶️ Retomar Busca",
        "BTN_PARAR_MASSA": "⏹️ Parar (Cancelar)",
        ...
        "STATUS_MASSA_PAUSADO": "⏸️ Busca pausada (Item {atual} de {total}). Clique em 'Retomar' para continuar.",
        "STATUS_MASSA_FIM": "✅ Varredura em lote concluída de forma segura! {qtd} cotações integradas.",
        
        # ABA 2 - COMPOSIÇÃO DE PREÇOS
        "TITULO_PAINEL": "### Painel de Ações por Item",
        "COL_LOTE": "Item (Lote)",
        "COL_DESC": "Descrição",
        "COL_STATUS": "Status Preço",
        "COL_ACOES": "Ações",
        "BADGE_PENDENTE": "Pendente",
        "BTN_PNCP": "🔍 PNCP",
        "BTN_MANUAL": "✍️ Cadastrar",
        "BTN_VALIDAR": "⚖️ Validar",
        ...
        # FEEDBACKS VISUAIS DO ROBÔ PNCP (UX)
        ...
        "STATUS_TENTATIVA_3": "⚠️ Tentativa 3: Expandindo tipos de documentos...",
...
def get_text(chave):
    return TEXTOS[LANG].get(chave, f"[{chave}]")

def get_format(chave):
    return FORMATOS[LANG].get(chave)